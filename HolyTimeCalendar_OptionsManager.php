...
class HolyTimeCalendar_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'holy-time-calendar'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'holy-time-calendar'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'holy-time-calendar'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'holy-time-calendar'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'holy-time-calendar');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'holy-time-calendar'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'holy-time-calendar');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'holy-time-calendar'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'holy-time-calendar') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'holy-time-calendar');
            case 'false':
                return __('false', 'holy-time-calendar');

            case 'Administrator':
                return __('Administrator', 'holy-time-calendar');
            case 'Editor':
                return __('Editor', 'holy-time-calendar');
            case 'Author':
                return __('Author', 'holy-time-calendar');
            case 'Contributor':
                return __('Contributor', 'holy-time-calendar');
            case 'Subscriber':
                return __('Subscriber', 'holy-time-calendar');
            case 'Anyone':
                return __('Anyone', 'holy-time-calendar');
        }
        return $optionValue;
    }
